...
<div class="container mt-3">
              ...
              $(this).siblings(".custom-file-label").addClass("selected").html(fileName);
                ...
                <div class="card-body">
                   <form method="POST" action="{{url('/add-video') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="assignment" class="col-md-3 col-form-label text-md-right">{{ __('Assignment') }}</label>

                            <div class="col-md-8">
                                <input id="assignment" type="file" class="form-control @error('assignment') is-invalid @enderror" name="assignment" value="{{ old('assignment') }}">
 ...
 -->
                        ...
                        <div class="form-group row youtube_url ">
                            ...
                            <div class="col-md-8">
                                <input id="youtube_url" type="text" class="form-control @error('youtube_url') is-invalid @enderror" name="youtube_url" value="{{ old('youtube_url') }}" autocomplete="youtube_url" autofocus>
